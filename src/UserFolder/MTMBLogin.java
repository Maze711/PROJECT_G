...
import AdminFolder.MTMBAdminMainFrame;
...
//		SECONDARY PANEL INSIDE LOGIN FRAME
		                    ...
		                    if (resultSet.next()) {
		                        ...
		                        if (enteredPassword.equals(storedPassword)) {
		                            ...
		                            if (authorization.equals("admin")) {
		                            	MTMBAdminMainFrame adminMainFrame = new MTMBAdminMainFrame(username);
		                            	adminMainFrame.showWindowHome();
		                            } else if (authorization.equals("user")) {
		                            	MTMBMainFrame userMainFrame = new MTMBMainFrame(username);
		                            	userMainFrame.showWindowHome();
		                            }
		                            dispose();
		                        } else {
		...
		lblNewLabel_1_1.setBounds(50, 343, 211, 20);
		...
		btnNewButton_1.setBounds(230, 340, 131, 28);
